...
setup(
    ...
    url='https://github.com/smetj/wishbone-decode-msgpack',
    download_url='https://github.com/smetj/wishbone-decode-msgpack/tarball/master',
    ...
    entry_points={
        'wishbone.decode': [
            'msgpack=wishbone_decode_msgpack:MSGPackDecode',
        ]
    }
)
